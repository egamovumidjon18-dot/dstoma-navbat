        ...
        <>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              <h3 className="text-xl font-bold text-white flex items-center gap-2">
                <History className="w-5 h-5 text-emerald-500" /> Muolaja Tarixi
              </h3>
              <p className="text-sm text-slate-500">Bemorning to'liq davolash tarixi va arxivi</p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex bg-[#0a0f1d] rounded-xl border border-slate-800 p-1">
                ...
                >
                  <Clock className="w-4 h-4" /> Taymlayn
                </button>
                <button 
                ...
                >
                  <LayoutList className="w-4 h-4" /> Jadval
                </button>
              </div>
          ...
          <div className="flex flex-wrap gap-4 mb-6 bg-[#0a0f1d] p-4 rounded-2xl border border-slate-800">
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input 
                type="text" 
                placeholder="Muolaja yoki tish raqamini izlash..." 
                value={searchTerm}
          ...
          <div className="flex-1 min-h-0 overflow-y-auto pr-2 custom-scrollbar">
            {filteredItems.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-slate-500 bg-[#0a0f1d] rounded-2xl border border-dashed border-slate-800 p-8">
                ...
                <p>Muolaja tarixi topilmadi yoki hali shakllanmagan.</p>
              </div>
            ) : viewMode === 'timeline' ? (
                    ...
                    <div key={item.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      ...
                      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] bg-[#0a0f1d] p-5 rounded-2xl border border-slate-800 shadow-sm hover:border-emerald-500/50 transition-all cursor-pointer" onClick={() => setSelectedRecord(item)}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs font-bold bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded-full">Bajarildi</span>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-slate-400">
                          <div className="flex items-center gap-1.5 bg-[#111827] px-2 py-1 rounded-lg">
                            <span className="text-emerald-500 font-bold">Tish:</span>
                ...
                <table className="w-full text-left text-sm whitespace-nowrap">
                  <thead className="bg-[#111827] text-slate-400 border-b border-slate-800">
                    <tr>
                      ...
                      <th className="px-6 py-4 font-bold text-xs uppercase tracking-wider">Muolaja turi</th>
            ...
            <div className="flex-1 space-y-6">
              <div className="bg-[#0a0f1d] rounded-2xl border border-slate-800 p-6">
                <div className="grid grid-cols-2 gap-6 mb-6">
                  <div>
                    <span className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Muolaja turi</span>
                    <p className="text-lg font-bold text-white">{selectedRecord.treatment}</p>
                  </div>
                  <div>
                    <span className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Shifokor</span>
                    <p className="text-base text-slate-300 flex items-center gap-2"><User className="w-4 h-4" /> {selectedRecord.doctorName}</p>
                  </div>
                  <div>
                    <span className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Tish raqami</span>
                  ...
                  <div>
                    <span className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Narx</span>
                ...
                {checkWarnings(selectedRecord.toothId, selectedRecord.createdAt) && (
                  <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3">
                    ...
                    <div>
                      <h5 className="text-sm font-bold text-amber-400 mb-1">Takroriy muolaja ogohlantirishi</h5>
                ...
                <div className="bg-[#0a0f1d] rounded-2xl border border-slate-800 p-5 hover:border-emerald-500/50 transition-colors cursor-pointer group">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h5 className="font-bold text-white text-sm">Bog'langan Rentgen</h5>
                    </div>
                ...
                <div className="bg-[#0a0f1d] rounded-2xl border border-slate-800 p-5 hover:border-emerald-500/50 transition-colors cursor-pointer group">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h5 className="font-bold text-white text-sm">Dental Chart</h5>
                    </div>
                    <LinkIcon className="w-4 h-4 text-slate-600 group-hover:text-emerald-500 transition-colors" />
                  </div>
                ...
                <div className="bg-[#0a0f1d] rounded-2xl border border-slate-800 p-5 hover:border-emerald-500/50 transition-colors cursor-pointer group">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h5 className="font-bold text-white text-sm">Foto Galereya</h5>
                    </div>
                    <LinkIcon className="w-4 h-4 text-slate-600 group-hover:text-emerald-500 transition-colors" />
                  </div>
              ...
              <div className="bg-[#0a0f1d] rounded-2xl border border-slate-800 p-6 sticky top-6">
                 ...
                 <div className="space-y-4 mb-6">
                   <div className="flex justify-between text-sm">
                     <span className="text-slate-400">Xizmat narxi</span>
                 ...
                 <div className="border-t border-slate-800 pt-4 mb-8">
                   <div className="flex justify-between items-center">
                     <span className="font-bold text-slate-300">Jami to'langan:</span>
