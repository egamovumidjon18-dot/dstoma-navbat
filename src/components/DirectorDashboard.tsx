...
export default function DirectorDashboard({
  ...
  const t = (text: string) => {
    ...
    const dict: Record<string, LocalDictEntry> = {
      ...
      "iltimos xizmat parametrlari to'g'riligini texshiring!": { ru: "Пожалуйста, проверьте параметры услуги!", en: "Please check service parameters!", kk: "Өтінеміз, қызмет параметрлерін тексеріңіз!", ky: "Сураныч, кызмат параметрлерин текшериңиз!", tg: "Лутфан, параметрҳои хизматро тафтиш кунед!", tk: "Haýyş, hyzmat parametrlerini barlaň!" },
